document.addEventListener("DOMContentLoaded", function(event) {
    AJS.$(function($) {
      ...
      AJS.toInit(function() {
        ...
        $("body").on("click", "#delete-all-reminders", function(e) {
          e.preventDefault();
          var dialog = new AJS.Dialog({
            width: 400,
            height: 200,
            id: "delete-all-reminders-dialog"
          });
          dialog.addHeader(AJS.I18n.getText("reminder.jira.reminder.delete.dialog.header"))
                .addPanel("Panel 1", "<p><strong>" + AJS.I18n.getText("reminder.jira.reminder.delete.all.dialog.content") + "</strong></p>", "panel-body")
                .addButtonPanel()
                .addButton(AJS.I18n.getText("common.words.yes"), function(dialog) {
                  $.ajax({
                    url: AJS.contextPath() + "/plugins/servlet/myReminders",
                    ...
                    success: function(response) {
                      ...
                      AJS.messages.success("#aui-message-bar", {
                        title: "Reminder",
                        body: "<p>All reminders deleted successfully.</p>",
                        delay: 10000,
                        duration: 1000,
                        fadeout: true
                      });
