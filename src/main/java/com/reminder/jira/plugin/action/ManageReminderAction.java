...
public class ManageReminderAction extends AbstractReminderAction {
    private static final Logger LOG = Logger.getLogger(ManageReminderAction.class);
   ...
   public List<ReminderDTO> getReminders() {
      return this.toReminderDTOs(this.aoReminderService.getAllReminders());
   }
